                    ...
                    <tbody>
                        ...
                        @foreach ($orders as $order)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('seller_order.details', $order->order_number) }}"
                            ...
                            @include('seller_dash.orders.update')
                            @include('seller_dash.orders.delete')
                            @include('seller_dash.orders.costumer_details')
                        @endforeach
                    </tbody>
                </table>
            </div>
