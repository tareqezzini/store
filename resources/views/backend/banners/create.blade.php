                    ...
                    <div class="card-body">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade active show" id="account" role="tabpanel"
                                ...
                                <form class="needs-validation user-add" method="POST" action="{{ route('banner.store') }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <textarea class="form-control m-0" name="description" id="desc" cols="" rows="3"></textarea>
                                        </div>
                                    </div>
