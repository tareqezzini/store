                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control" id="email" name="email" type="text"
                                                value="{{ $vendor->email }}" placeholder="Enter email ...." required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control" id="full_name" name="full_name" type="text"
                                                value="{{ $vendor->full_name }}" placeholder="Enter full name ...."
                                                required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control" id="user_name" name="user_name" type="text"
                                                value="{{ $vendor->user_name }}" placeholder="Enter user_name ...."
                                                required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control" id="phone" name="phone" type="text"
                                                value="{{ $vendor->phone }}" placeholder="Enter phone ...." required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                            ...
                                            <div
                                                ...
                                                <label class="d-block" for="edo-ani3">
                                                    <input class="radio_animated" value="active" id="edo-ani3"
                                                        type="radio" name="status" @checked($vendor->status == 'active')>
                                                    Active
                                                </label>
                                                <label class="d-block" for="edo-ani4">
                                                    <input class="radio_animated" value="inactive" id="edo-ani4"
                                                        type="radio" name="status" @checked($vendor->status == 'inactive')>
                                                    Inactive
                                                </label>
                                            </div>
                                        </div>
