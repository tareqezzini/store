                    ...
                    <div class="card-body">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade active show" id="account" role="tabpanel"
                                ...
                                <form class="needs-validation user-add" method="POST" action="{{ route('vendor.store') }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control" id="user_name" name="user_name" type="text"
                                                value="{{ old('user_name') }}" placeholder="Enter user_name ...." required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="password_confirmation" class="col-xl-3 col-md-4">Confirm Your
                                            Password</label>
                                        <div class="col-xl-8 col-md-7">
