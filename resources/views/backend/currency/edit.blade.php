            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="breadcrumb-item">Edit Currency</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade active show" id="account" role="tabpanel"
                                ...
                                <form class="needs-validation user-add" method="POST"
                                    action="{{ route('currency.update', $currency->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-5 col-md-12">
                                            <input class="form-control" id="exchange" name="exchange" type="number"
                                                step="0.01" value="{{ $currency->exchange }}" required>
                                            @error('exchange')
                                                <span class="text-danger mt-2">
                                                    {{ $message }}
                                                </span>
                                            ...
                                            <div
                                                ...
                                                <label class="d-block" for="edo-ani3">
                                                    <input class="radio_animated" value="active" id="edo-ani3"
                                                        type="radio" name="status" @checked($currency->status == 'active')>
                                                    Active
                                                </label>
                                                <label class="d-block" for="edo-ani4">
                                                    <input class="radio_animated" value="inactive" id="edo-ani4"
                                                        type="radio" name="status" @checked($currency->status == 'inactive')>
                                                    Inactive
                                                </label>
                                            </div>
                                        </div>
