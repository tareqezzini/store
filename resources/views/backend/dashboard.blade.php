                    ...
                    <div class="warning-box card-body">
                        <div class="media static-top-widget align-items-center">
                            ...
                            <div class="media-body media-doller">
                                ...
                                <h3 class="mb-0">$ <span class="counter">{{ $earning }}</span><small> This
                                        Month</small>
                                </h3>
                            </div>
                        </div>
                    ...
                    <div class="secondary-box card-body">
                        <div class="media static-top-widget align-items-center">
                            ...
                            <div class="media-body media-doller">
                                ...
                                <h3 class="mb-0"> <span class="counter">{{ $numberProductSales }}</span><small> This
                                        Month</small>
                                </h3>
                            </div>
                        </div>
            ...
            <div class="col-xxl-3 col-md-6 xl-50">
                <div class="card o-hidden widget-cards">
                    <div class="primary-box card-body">
                        <div class="media static-top-widget align-items-center">
                            <div class="icons-widgets">
                                <div class="align-self-center text-center"><i data-feather="user" class="font-primary"></i>
                                </div>
                            </div>
                            <div class="media-body media-doller"><span class="m-0">New Costumer</span>
                                <h3 class="mb-0"> <span class="counter">{{ $numberCostumer }}</span><small> This
                                        Month</small></h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="danger-box card-body">
                        <div class="media static-top-widget align-items-center">
                            ...
                            <div class="media-body media-doller"><span class="m-0">New Vendors</span>
                                <h3 class="mb-0"> <span class="counter">{{ $numberVendors }}</span><small> This
                                        Month</small></h3>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="user-status table-responsive latest-order-table">
                                ...
                                <tbody>
                                    @foreach ($latestOrders as $order)
                                        <tr>
                                            ...
                                            <td class="digits">${{ $order->total_amount }}</td>
                                            <td class="digits">
                            ...
                            <a href="{{ route('order.index') }}" class="btn btn-primary mt-4">View All Orders</a>
                        </div>
                    </div>
                </div>
            </div>
