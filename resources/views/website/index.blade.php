...
@section('content')
                                    ...
                                    <div>
                                        <div>
                                            <img src="{{ asset('images/Categories/' . $cat->image) }}"
                                                class="img-fluid blur-up lazyload bg-img" alt="{{ $cat->titel }}">
                                        </div>
                                        <h4>{{ $cat->title }}</h4>
                                        <a href="{{ route('product_category', $cat->slug) }}" class="btn btn-outline">shop
                                            Now</a>
                                    </div>
                                </div>
                            @endforeach
        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="product-para">
                    <p class="text-center">Looking for the latest trends in clothing, shoes and
                        accessories?
                        Welcome to
                        our 'Latest Drops' edit, bringing you all the latest styles from all your
                        fave brands.</p>
                </div>
            </div>
        </div>
                            ...
                            <div class="product-box pb-2" style="border: 1px solid #e7e7e7">
                                <div class="img-wrapper">
                                    <div class="lable-block">
                                        <span class="lable3 " style="border-radius: 100%">new</span>
                                    </div>
                                    <div class="front">
                                        <a href="{{ route('product.details', $new_product->slug) }}">
                                            <img src="{{ asset('images/Products/' . $new_product->image) }}"
                                                class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                    </div>
                                    <div class="cart-info cart-wrap">

                                        {{-- @livewire('add-to-cart', ['product_details' => $new_product, 'button' => '<button type="submit" ><i class="ti-shopping-cart"></i></button>'], key($new_product->id))
                                ...
                                <div class="product-detail">
                                    ...
                                    <h4>{{ App\Utils\Helper::convertPrice($new_product->offer_price) }}
                                        <del>{{ App\Utils\Helper::convertPrice($new_product->price) }}</del>
                                    </h4>
                                </div>
                            </div>
                        @endforeach
                        ...
                        @foreach ($brands as $brand)
                            <div>
                                <div class="logo-block">
                                    ...
                                    <img src="{{ asset('images/Brands/' . $brand->image) }}" alt="" width="80"
                                        height="80">
                                </div>
                            </div>
                        @endforeach
    ...
    <!-- Parallax banner -->
    @if ($promo = App\Models\Banner::where('condition', 'promo')->first())
        <section class="p-0">
            <div class="full-banner parallax text-center p-left">
                <img src="{{ asset('images/Banners/' . $promo->image) }}" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="banner-contain">
                                <h2>{{ $promo->title }}</h2>
                                <h3>special offer</h3>
                                <p style="font-size: 30px; color: white; letter-spacing: 1.5px;">
                                    {{ $promo->description }}</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="theme-tab">
                        <ul class="tabs tab-title">
                            <li class="current"><a href="tab-4">Top Product Selling</a></li>
                            <li class=""><a href="tab-5">Top Product reated</a></li>
                        </ul>
